  ...
  <head>
    ...
    <title><?php echo $title; ?> | Rhoa Z</title>
    <!-- Favicon -->
    ...
    <style>
      div.header, nav.my-navbar-top {
        background-color: #F1A710 !important;
      }
      div.bg-default {
  ...
  <body class="@yield('sidebar_type')">
      ...
      <div class="scrollbar-inner">
        ...
        <div class="sidenav-header d-flex align-items-center">
          <a class="navbar-brand" href="<?php echo base_url(); ?>">
            <img src="<?php echo get_theme_uri('images/logo1.png'); ?>" class="navbar-brand-img" alt="Logo <?php echo get_store_name(); ?>">
          </a>
          <div class="ml-auto">
            <!-- Sidenav toggler -->
    ...
    <div class="main-content" id="panel">
      <!-- Topnav -->
      <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom my-navbar-top">
