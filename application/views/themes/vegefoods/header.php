...
<head>
	<title>Selamat Datang Di Rhoa Z</title>
	<meta charset="utf-8">
...
<body class="goto-here">
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark text-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container text-dark">

			<a class="navbar-brand" href="<?php echo base_url(); ?>">
				<img src="<?php echo get_theme_uri('images/logo.jpeg'); ?>" alt="" width="100">	
			</a>

			<button class="navbar-toggler text-dark" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation" id="btn-menu">
				<span class="oi oi-menu"></span> Menu
			</button>

			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="<?php echo base_url(); ?>" class="nav-link text-dark">Home</a></li>
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle text-dark" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Shop</a>
					...
					<li class="nav-item">
						<a href="<?php echo site_url('pages/about'); ?>" class="nav-link text-dark">Tentang Kami</a>
					</li>
					<li class="nav-item">
						<a href="<?php echo site_url('pages/contact'); ?>" class="nav-link text-dark">Kontak</a>
					</li>
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle text-dark" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Akun</a>
					...
					<li class="nav-item cta cta-colored">
						...
						<span class="icon-shopping_cart"></span>[<span class="cart-item-total">0</span>]</a>
					</li>
				</ul>
			</div>
		</div>
