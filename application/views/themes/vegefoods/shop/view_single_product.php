          ...
          <div class="row">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <p><a href="https://api.whatsapp.com/send?phone=6281343722021&text=Halo%20saya%20mau%20beli%20produk:%0A<?= $product->name; ?>%20(Rp%20<?php echo ($product->current_discount > 0) ? ($product->price - $product->current_discount) : $product->price; ?>)" class="btn btn-black btn-sm py-3 px-5" target="_blank"><span></span> Pesan via whatsapp</a></p>
                </div>
            </div>
              </div>
          </div>
