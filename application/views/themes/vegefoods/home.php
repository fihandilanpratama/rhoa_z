...
<section id="home-section" class="hero">
  <div class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg_main.JPG'); ?>);">
      <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">RHOA Z</h1>
            <!-- <h2 class="subheading mb-4">Sayur dan Buah Segar Langsung dari Kebun</h2> -->
            <h2 class="subheading mb-4" style="font-size: 25px">kami Menjual Berbagai Camilan Khas Ternate</h2>
  ...
  <div class="container">
    <div class="row justify-content-center mb-3 pb-3">
      <div class="col-md-12 heading-section text-center ftco-animate">
        ...
        <h2 class="mb-4">RHOA Z</h2>
        <p>Belanja berbagai macam camilan khas ternate</p>
      </div>
    </div>
  </div>
  <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="alert alert-primary text-center">
                            Belum ada produk yang tersedia. Silahkan kontak admin atau tunggu hingga produk ditambahkan.
                        </div>
                    </div>
                </div>
            </div>
